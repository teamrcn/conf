...
#alias f="ls -l --color=auto"
    ...
    function ipaddress(){ dig +short myip.opendns.com @resolver1.opendns.com; }
...
# {{{ Program specific settings
    ...
    alias utc="date +%s;TZ=America/New_York date; TZ=UTC date; TZ=Australia/Sydney date;"
# }}}

# {{{ place software dev configs here
    alias d="docker"
